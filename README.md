...
- **Melinda Tran:** Designed the model structure, front-end and backend of the calendar.
- **Justin Pescador:** Implemented create,delete, and update tasks features of the calendar.
